...
OpenFinTech.io — speeds up development and helps FinTech-services to communicate in one language.
...
_"Fintech international standards are only on the stage of development. That's why we created OpenFinTech.io and made it accessible to the entire community!"_, Founder PayCore.io, Denys Kyrychenko.

_"With a constant increase in the number of services, communication between them becomes more and more complicated. OpenFinTech.io - is just-in-time and what we need!"_, Founder SDK.Finance, Pavlo Sidelev.                     
